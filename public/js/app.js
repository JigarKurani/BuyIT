...
var productDesc = document.querySelectorAll(".productDesc"); // mobile nav

var butn = document.querySelector(".mobile-menu-button");
...
function updateCart(product) {
  ...
  if (ele.length != 0) {
    ...
    for (i = 0; i < ele.length; i++) {
      if (ele[i].checked) selected = ele[i].value;
    }

    product.size = selected;
  }

  axios.post("/update-cart", product).then(function (res) {
...
productDesc.forEach(function (btn) {
...
function removeCartFunction(product) {
  axios.post("/remove-item", product).then(function (res) {
    //Yo 
    cartCounter.innerText = res.data.totalQty;
    location.reload();
  });
...
updateStatus(order); //Socket intigration
...
if (adminAreaPath.includes("admin")) {
  (0,_admin__WEBPACK_IMPORTED_MODULE_0__.initAdmin)(socket);
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51Ib1I4SEriRYiI6aRwV9F3ZqUyQVlWkjGHgLFNbqvKKkMmMVfbPzruL4T9mOCbB1tok6w8KutoyYHfJcvlFv62Bv00g7uR1VU1');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkbuyitjv"] = self["webpackChunkbuyitjv"] || [];
